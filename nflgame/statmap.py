"""
This is an unedited copy from the nflgame package located in
GitHub at https://github.com/BurntSushi/nflgame. Comments indicate
that package is no longer maintained therefore I'm not worried
about bug fixes occurring that I won't benefit from. I don't
simply indicate that package as a dependency because it
installs much more then I want.

What follows is from the source file
---------------------------------------------------------------------------
